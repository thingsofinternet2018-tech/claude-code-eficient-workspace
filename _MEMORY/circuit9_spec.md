---
tags: [circuit9, spec, sincretism, adaptive-routing, decision-rules]
created: 2026-05-11
type: specification
---
...
| Resurse limitate (RAM/CPU înalt) | 3 sau 5 | Scurtat automat | Eficiență + supraviețuire sistem | Server încărcat cu alte procese |
...
def decide_circuit9_length(task: str, context) -> int:
    ...
    resource_load = get_system_load()               # RAM, CPU sistem
...
- Implementare: `agent_skills/circuit9.py`
