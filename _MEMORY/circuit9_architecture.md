---
tags: [circuit9, architecture, memory-layers, adaptive-routing]
created: 2026-05-10
---
...
- Modul Python: `agent_skills/circuit9.py`
- Trigger: `python3 -c "import urllib.request,json; print(urllib.request.urlopen('http://127.0.0.1:9879/skills/circuit9_run/run', data=json.dumps({'args':['TASK_TEXT']}).encode()).read().decode())"`
